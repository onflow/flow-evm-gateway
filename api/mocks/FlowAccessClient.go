...
// MockAccessClient is an autogenerated mock type for the FlowAccessClient type
type MockAccessClient struct {
	mock.Mock
}

// Close provides a mock function with given fields:
func (_m *MockAccessClient) Close() error {
	ret := _m.Called()
...
func (_m *MockAccessClient) ExecuteScriptAtBlockHeight(ctx context.Context, height uint64, script []byte, arguments []cadence.Value) (cadence.Value, error) {
...
func (_m *MockAccessClient) ExecuteScriptAtBlockID(ctx context.Context, blockID flow.Identifier, script []byte, arguments []cadence.Value) (cadence.Value, error) {
...
func (_m *MockAccessClient) GetAccount(ctx context.Context, address flow.Address) (*flow.Account, error) {
...
func (_m *MockAccessClient) GetAccountAtBlockHeight(ctx context.Context, address flow.Address, blockHeight uint64) (*flow.Account, error) {
...
func (_m *MockAccessClient) GetAccountAtLatestBlock(ctx context.Context, address flow.Address) (*flow.Account, error) {
	ret := _m.Called(ctx, address)
...
func (_m *MockAccessClient) GetBlockByHeight(ctx context.Context, height uint64) (*flow.Block, error) {
...
func (_m *MockAccessClient) GetBlockByID(ctx context.Context, blockID flow.Identifier) (*flow.Block, error) {
...
func (_m *MockAccessClient) GetBlockHeaderByHeight(ctx context.Context, height uint64) (*flow.BlockHeader, error) {
	ret := _m.Called(ctx, height)
...
func (_m *MockAccessClient) GetBlockHeaderByID(ctx context.Context, blockID flow.Identifier) (*flow.BlockHeader, error) {
	ret := _m.Called(ctx, blockID)
...
func (_m *MockAccessClient) GetCollection(ctx context.Context, colID flow.Identifier) (*flow.Collection, error) {
...
func (_m *MockAccessClient) GetEventsForBlockIDs(ctx context.Context, eventType string, blockIDs []flow.Identifier) ([]flow.BlockEvents, error) {
...
func (_m *MockAccessClient) GetEventsForHeightRange(ctx context.Context, eventType string, startHeight uint64, endHeight uint64) ([]flow.BlockEvents, error) {
...
func (_m *MockAccessClient) GetExecutionDataByBlockID(ctx context.Context, blockID flow.Identifier) (*flow.ExecutionData, error) {
	ret := _m.Called(ctx, blockID)
...
func (_m *MockAccessClient) GetExecutionResultForBlockID(ctx context.Context, blockID flow.Identifier) (*flow.ExecutionResult, error) {
	ret := _m.Called(ctx, blockID)
...
func (_m *MockAccessClient) GetLatestBlock(ctx context.Context, isSealed bool) (*flow.Block, error) {
...
func (_m *MockAccessClient) GetLatestBlockHeader(ctx context.Context, isSealed bool) (*flow.BlockHeader, error) {
	ret := _m.Called(ctx, isSealed)
...
func (_m *MockAccessClient) GetLatestProtocolStateSnapshot(ctx context.Context) ([]byte, error) {
	ret := _m.Called(ctx)
...
func (_m *MockAccessClient) GetNetworkParameters(ctx context.Context) (*flow.NetworkParameters, error) {
	ret := _m.Called(ctx)
...
func (_m *MockAccessClient) GetTransaction(ctx context.Context, txID flow.Identifier) (*flow.Transaction, error) {
...
func (_m *MockAccessClient) GetTransactionResult(ctx context.Context, txID flow.Identifier) (*flow.TransactionResult, error) {
	ret := _m.Called(ctx, txID)
...
func (_m *MockAccessClient) GetTransactionResultsByBlockID(ctx context.Context, blockID flow.Identifier) ([]*flow.TransactionResult, error) {
	ret := _m.Called(ctx, blockID)
...
func (_m *MockAccessClient) GetTransactionsByBlockID(ctx context.Context, blockID flow.Identifier) ([]*flow.Transaction, error) {
	ret := _m.Called(ctx, blockID)
...
func (_m *MockAccessClient) Ping(ctx context.Context) error {
	ret := _m.Called(ctx)
...
func (_m *MockAccessClient) SendTransaction(ctx context.Context, tx flow.Transaction) error {
...
func (_m *MockAccessClient) SubscribeEventsByBlockHeight(ctx context.Context, startHeight uint64, filter flow.EventFilter) (<-chan flow.BlockEvents, <-chan error, error) {
...
func (_m *MockAccessClient) SubscribeEventsByBlockID(ctx context.Context, startBlockID flow.Identifier, filter flow.EventFilter) (<-chan flow.BlockEvents, <-chan error, error) {
...
func (_m *MockAccessClient) SubscribeExecutionDataByBlockHeight(ctx context.Context, startHeight uint64) (<-chan flow.ExecutionDataStreamResponse, <-chan error, error) {
...
func (_m *MockAccessClient) SubscribeExecutionDataByBlockID(ctx context.Context, startBlockID flow.Identifier) (<-chan flow.ExecutionDataStreamResponse, <-chan error, error) {
...
type mockConstructorTestingTNewMockAccessClient interface {
	mock.TestingT
	Cleanup(func())
}

// NewMockAccessClient creates a new instance of MockAccessClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockAccessClient(t mockConstructorTestingTNewMockAccessClient) *MockAccessClient {
	mock := &MockAccessClient{}
	mock.Mock.Test(t)
