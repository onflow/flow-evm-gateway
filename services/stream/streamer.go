...
// TODO this is copied code from flow-go with a change that is included in the flow-go master
// https://github.com/onflow/flow-go/blob/master/engine/access/subscription/streamer.go#L103-L105
// but since we need feature/stable-cadence branch and that is not yet updated with master
// we can't import those changes, after stable-cadence branch is updated we have to remove this
